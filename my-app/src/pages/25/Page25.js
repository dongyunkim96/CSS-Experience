        ...
        <div className="frame25">
            <div className="marco">
                ...
                <input type="checkbox" id="btn" />
                    <label for="btn">
                        <div className="icono">
                            <svg width="48px" height="72px" viewBox="0 0 48 72" className="marcador">
                        ...
                        <div className="info25">
                            <img src="https://images.pexels.com/photos/3672776/pexels-photo-3672776.jpeg" className="header25" alt="img" />
                            <p className="datos"><span className="titulo">Great Falls</span> <br />Virginia, United States.
                            </p>
                            <div className="acciones">
                                <a href="/save">Save</a><span>|</span><a href="/route">Route</a>
                            </div>
                        </div>
                    </label>
            </div>
