...
const Page43 = () => {
    ...
    const handleBulbHover = () => {
        setIsBulbHovered((prevHovered) => !prevHovered);
    };
    ...
    return (
        <Frame43>
            <BulbSVG43
              ...
              height="94px"
              viewBox="0 0 76 94"
              onClick={handleBulbHover}
              isHovered={isBulbHovered}
            >
            ...
            <Glow43 id="glow" isHovered={isBulbHovered} />
            <BaseSVG43 id="base" width="32px" height="33px" viewBox="0 0 32 33">
